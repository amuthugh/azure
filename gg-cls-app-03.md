...
```
az account set --subscription 0095b3e5-a31e-42af-aa85-adc4e6fa8ea9
export rgName=gg-sy-prod-east-us2-rg
export location=eastus2 
export vnetName=gg-gg-sy-prod-east-us2-vnet
export vnetAddPrefix=10.14.16.0/20
export subnetName=gg-cls-app-03-subnet
export subnetPrefix=10.14.16.0/26
export aksName=gg-cls-app-03
export nodeVmSize=Standard_D4s_v5
export tagsSn="product=Synkrato customer=Zebra environment=PROD,DR hasNexus=No applications=CLS,Synkrato serversize=Standard_D4s_v5"
```
```

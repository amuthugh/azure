	centralus	gg-ex-prod-central-us-vnet	10.9.32.0/20	gg-ex-prod-app-01-subnet	10.9.32.64/26	Standard_E4as_v5	product=Exto customer=exto environment=Prod hasNexus=No application=exto-platform, Bolo


AKS Instance creation 
...
export aksName=gg-ex-prod-app-01
export rgName=gg-ex-prod-central-us-rg
export location=centralus 
export vnetName=gg-ex-prod-central-us-vnet
export vnetAddPrefix=10.9.32.0/20
export subnetName=gg-ex-prod-app-01-subnet
export subnetPrefix=10.9.32.64/26
export nodeVmSize=Standard_E4as_v5
export tagsSn="product=Exto customer=exto environment=Prod hasNexus=No application=exto-platform, Bolo"
